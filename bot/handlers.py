...
strings = {
    ...
    "ask": "Спросить",
    "back": "Главная",
    "hi": "Я суперпупермегаумный бот.",
    "request_pdf": "Отправьте PDF-файл или введите текст",
    "success": "Файл успешно сохранён. Хотите отправить еще?",
    "noinput": "Отправьте непустое сообщение!",
    "pleasereset": 'Пожалуйста, нажмите кнопку "Главная" внизу.',
    "tba": "Такой функции у нас пока нет((",
}
...
async def handle_upload_button(message: Message):
    ...
    await message.answer(strings["request_pdf"], reply_markup=get_empty_keyboard())
